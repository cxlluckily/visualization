...
public class MyHiveDatabaseMetaData implements DatabaseMetaData {
	
	private DatabaseMetaData metaData;
	
	public MyHiveDatabaseMetaData(DatabaseMetaData metaData) {
	...
	public ResultSet getPseudoColumns(String catalog, String schemaPattern, String tableNamePattern,
		...
		return metaData.getPseudoColumns(catalog, schemaPattern, tableNamePattern,
				columnNamePattern);
	}
