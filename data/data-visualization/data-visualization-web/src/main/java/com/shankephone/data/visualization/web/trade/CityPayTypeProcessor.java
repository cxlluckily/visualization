...
/**      
 * @ClassName: CityPayTypeProcessor  
 * @Description: TODO
 * @author yaoshijie  
 * @date 2018年2月7日    
 */
public class CityPayTypeProcessor implements SubDataInitProcessor {

	private final static Logger logger = LoggerFactory.getLogger(CityPayTypeProcessor.class);
