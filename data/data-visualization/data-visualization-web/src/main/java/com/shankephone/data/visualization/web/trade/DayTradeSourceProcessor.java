...
/**      
 * @ClassName: DayTradeSourceProcessor  
 * @Description: TODO
 * @author yaoshijie  
 * @date 2018年2月1日    
 */
public class DayTradeSourceProcessor implements SubDataInitProcessor {

	private final static Logger logger = LoggerFactory.getLogger(DayTradeSourceProcessor.class);
